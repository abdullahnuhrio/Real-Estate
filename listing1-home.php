...
<body>
    ...
    <div class="listing">
        <div class="main-image">
            <img id="mainImage" src="images/home.jpg" alt="Main Image">
        </div>
        <div class="thumbnails">
            <img src="images/home1.jpg" alt="Thumbnail 1" onclick="showMainImage('images/home1.jpg')">
            <img src="images/home2.jpg" alt="Thumbnail 2" onclick="showMainImage('images/home2.jpg')">
            <img src="images/home3home.jpg" alt="Thumbnail 3" onclick="showMainImage('images/home3home.jpg')">
            <img src="images/home4.jpg" alt="Thumbnail 4" onclick="showMainImage('images/home4.jpg')">
            <img src="images/home5.jpg" alt="Thumbnail 5" onclick="showMainImage('images/home5.jpg')">
        </div>
    ...
    <form action="purchaseproperty.php" method="post">
        ...
        <input type="submit" value="Buy Now " name="buy" class="Buy Now">
